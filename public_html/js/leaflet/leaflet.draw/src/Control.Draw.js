L.Control.Draw = L.Control.extend({
    ...
    initialize: function(options) {
        ...
        if (L.DrawToolbar && this.options.draw) {
            ...
            id = L.stamp(toolbar);
            this._toolbarsNames['draw'] = id;//khomichenko +
        ...
        if (L.EditToolbar && this.options.edit) {
            ...
            id = L.stamp(toolbar);
            this._toolbarsNames['edit'] = id;//khomichenko +
            this._toolbars[id] = toolbar;
    ...
    getToolbar: function(name) {//khomichenko +
        return this._toolbars[this._toolbarsNames[name]];
    }
});
