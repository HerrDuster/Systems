L.Control.Window = L.Control.extend({
    ...
    initialize: function (container, options) {
        ...
        //this._wrapper.setAttribute('style','width:"100%"');
        //this._wrapper.setAttribute('style','height:' +window && window.height ? window.height : document.height +'px');
        ...
        if (this.options.closeButton) {
            this._closeButton = L.DomUtil.create('a', 'close',this._containerContent);
        ...
        if (this.options.closeButton) {
            ...
            L.DomEvent
                    .on(this._wrapper, 'click', this.hide, this)
                    .on(close, 'click', this.hide, this);
        }
    ...
    show: function (position) {
        ...
        if (this._closeButton) {
            L.DomEvent.addListener( this._closeButton, 'keypress', this.press, this);
        }        
        */
